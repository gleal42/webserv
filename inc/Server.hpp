...
/*   Updated: 2022/09/05 23:13:35 by gleal            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
public:
	...
	void				path_resolve( URI & uri, const ServerConfig & server_conf);
	...
	void				directory_indexing_resolve( URI & uri, std::string &root, const ServerConfig &server_conf, Location_const_it locations);
